...
// 使用TIME库
// 影响stamptime等功能
#define LOADSCRIPT_USE_TIME

//
namespace MX{	

//
#define __loadscript_out	__out
#define __loadscript_in		__in
#define __loadscript_inout	__inout
...
#define ScriptCharW			wchar_t
#define ScriptStringA		std::string
#define ScriptStringW		std::wstring

//
#if defined(__UNIX__) || defined(__APPLE__)
	#define ScriptStringT		std::string
#else
	#ifdef _UNICODE
		#define ScriptStringT	ScriptStringW
	#else	// _UNICODE
		#define ScriptStringT	ScriptStringA
	#endif	// _UNICODE
#endif
